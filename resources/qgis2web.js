...
map.getView().fit([-7520060.266264, -5761167.208777, -7505673.704993, -5750198.621027], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Playones deportivos y espacios verdes en Comodoro Rivadavia</h2>';
        return titleElement;
    })(),
